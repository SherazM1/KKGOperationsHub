...
def _empty_diagnostic_result() -> SegmentationDiagnosticResult:
    return SegmentationDiagnosticResult(
        ...
        diagnostics=SegmentationDiagnostics(
            ...
            strategy_a_raw_proposal_count=0,
            strategy_a_proposals_after_geometry_filter=0,
            strategy_a_rejected_degenerate=0,
            strategy_a_rejected_too_small=0,
            strategy_a_rejected_too_large=0,
            strategy_a_rejected_aspect_ratio=0,
            strategy_a_rejected_near_whole_image=0,
            strategy_b_raw_proposal_count=0,
            strategy_b_proposals_after_geometry_filter=0,
            strategy_b_rejected_degenerate=0,
            strategy_b_rejected_too_small=0,
            strategy_b_rejected_too_large=0,
            strategy_b_rejected_aspect_ratio=0,
            strategy_b_rejected_near_whole_image=0,
            strategy_c_raw_proposal_count=0,
            strategy_c_proposals_after_geometry_filter=0,
            strategy_c_rejected_degenerate=0,
            strategy_c_rejected_too_small=0,
            strategy_c_rejected_too_large=0,
            strategy_c_rejected_aspect_ratio=0,
            strategy_c_rejected_near_whole_image=0,
            merged_pool_count_before_dedup=0,
